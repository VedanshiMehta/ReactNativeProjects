...
import { addPostApi } from '../../../../core/services/redux'
...
type ScreenProps = NativeStackScreenProps<StackParamList, typeof RoutesConstants.AddUser>;
...
const AddUser = (props:UserContainerProps) => {
    ...
    function onClickedSubmit(): void {
        if(title!= '' || body != '')
        {
            ...
            setTitle('')
            setBody('')
            if (props.userData.users != null && props.userData.error === '') {
                     Utils.showSnackBar('Post added successfully', false);
                        props.navigation.pop();
            } else {
                Utils.showSnackBar(props.userData?.error || 'Something went wrong', false);
            }
        } 
    }
