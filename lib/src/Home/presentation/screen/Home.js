...
import { fetchPostsFromApi } from '../../data/api_service/PostApiData';
...
// >;
// type PostsContainerProps = PropsWithChildren<
//     ScreenProps & {
//     // postData: {
//     //     isLoading: boolean;
//     //     posts: PostData[];
...
const Home = (props /*: PostsContainerProps*/) => {
    ...
    const { isLoading, data: post, isError, error,refetch} = useQuery('posts', fetchPostsFromApi,
        {enabled: false,});
